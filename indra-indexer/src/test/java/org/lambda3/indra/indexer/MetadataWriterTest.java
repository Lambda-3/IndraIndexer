...
public class MetadataWriterTest {
    ...
    public void corpusMetadataTest() {
        ...
        try {
            ...
            MetadataWriter.write(modelDir.getAbsolutePath(), cm);

            CorpusMetadata loaded = MetadataWriter.load(modelDir.getAbsolutePath(), CorpusMetadata.class);
    ...
    public void modelMetadataTest() {
        ...
        try {
            File modelDir = Files.createTempDirectory("indra").toFile();
            MetadataWriter.write(modelDir.getAbsolutePath(), mm);

            ModelMetadata loaded = MetadataWriter.load(modelDir.getAbsolutePath(), ModelMetadata.class);
